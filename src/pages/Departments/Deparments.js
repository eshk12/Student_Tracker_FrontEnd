...
import {getDepartments} from "../../microservices/departments/departments";
...
const Departments = props => {
    ...
    useEffect(() => { //act like componentDidMount
        getDepartments().then((response) => {
            if (response.errorCode !== null && response.errorName !== null) {
                ...
                setDepartmentsList(response.object)
            }
        }).catch((e) => {
    ...
    const handleTableChange = (type, {page, searchText}) => {
        setDepartmentsList(
            departmentsList.filter(institute =>
